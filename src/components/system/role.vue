      ...
      <Row class="split-view">
        <Col span="8">
          <div class="split-pane-left">
            ...
            <Table border ref="selection" :columns="roleCloumns" :data="roleDatas" :min-height="200"
        ...
        <Col span="14" class="split-pane-right">
          <Tabs value="name1">
            <TabPane label="关联用户" icon="ios-people" name="name1">
              ...
              <Table border ref="selection" :columns="userCloumns" :data="userDatas" :min-height="200"
                     style="margin-top:10px;">
                <template slot-scope="{ row, index }" slot="action">
