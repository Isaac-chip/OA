  ...
  <div>
    <Table border :columns="columns" :loading="ruleLoading" :data="records">
      ...
      <template slot-scope="{ row }" slot="action">
        ...
        <Button :type="row.disabled?'primary':'error'" size="small" @click="selectedRule('disabled',`/political/score/rule/disabled/${row.id}`)">{{row.disabled?'开启':'禁用'}}</Button>

        <Button type="error" size="small" @click="selectedRule('delete',`/political/score/rule/${row.id}`)">删除</Button>
