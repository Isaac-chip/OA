    ...
    <table class="table table-bordered" id='hl-tree-table'>
      ...
      <tr>
        <th v-for="(index, column) in cloneColumns">
          <Checkbox :checked.sync="checks" @click.prevent="handleCheckAll"
          ...
          <label v-else>
            ...
            <span class="ivu-table-sort" v-if="column.sortable">
                        <Icon type="arrow-up-b" :class="{on: column._sortType === 'asc'}"
                              @click="handleSort($index, 'asc')"></Icon>
                         <Icon type="arrow-down-b" :class="{on: column._sortType === 'desc'}"
                               @click="handleSort($index, 'desc')"></Icon>
                    </span>
          </label>
        </th>
      </tr>
      ...
      <tr v-for="(index, item) in initItems" v-show="show(item)" :class="{'child-tr':item.parent}">
        <td v-for="column in columns" :style=tdWidth(column.width)>
          ...
          <div v-if="column.type === 'action'">
            <Button :type="action.type" size="small" @click="RowClick(item,index,$event,action.text)"
