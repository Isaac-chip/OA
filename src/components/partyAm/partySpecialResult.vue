  ...
  export default {
    ...
    methods: {
      ...
      handleDelete: function (data) {
        var self = this
        self.$http({
          url: self.$constants.BIURL + '/partySpecialResult/'+data.id,
          method: 'DELETE'
      ...
      loadPartyAmDatas: function () {
        ...
        console.log(self.params.deptCode);
        self.$http({
      ...
      exportExcel:function(){
        self.params.deptCode = self.$constants.userInfo.deptCode;
        exportUtils.exportExcel(this.$constants.BIURL+'/partySpecialResult/exportExcel',self.params);
      }
    },
    mounted: function () {
      this.loadPartyAmDatas()
