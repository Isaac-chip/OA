<template>
    <div class="bi-main-container">
        ...
        <div class="bi-container">
            <Row class="header">
            <Col  span="2"><Button @click="addPartyAm=true;isUpdate = false">新增</Button></Col>
            ...
            <div>
                ...
                <Row>
                    ...
                    <FormItem label="目标要求" prop="target">
                        <Input v-model="amListfromValidate.target" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请输入描述..." />
                    </FormItem>
                    <FormItem label="备注说明" prop="memo">
                        <Input v-model="amListfromValidate.memo" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请输入描述..." />
                    </FormItem>
                    <FormItem>
                ...
                <FormItem label="考核对象">
                    ...
                    <div v-show="partyCom">
                        <div style="margin:0px 28px">
                            ...
                            <div style="margin-top:10px">
                                <Tag v-for="item in partyOutOrgs" type="dot" closable color="primary" @on-close="deletePartyOrgs(item)">{{item.deptName}}</Tag>
                            </div>
                    ...
                    <div v-show="partyZb"> 
                        ...
                        <div style="margin:0px 28px">
                            ...
                            <div style="margin-top:10px">
                                <Tag v-for="item in partyOutBranchs" type="dot" closable color="primary" @on-close="deletePartyOutBranchs(item)">{{item.deptName}}</Tag>
                            </div>
                    ...
                    <div v-show="partyPeople">
                        ...
                        <div style="margin:0px 28px">
                            ...
                            <div style="margin-top:10px">
                                <Tag v-for="item in partyOutPeoples" type="dot" closable color="primary" @on-close="deletePartyOutPeoples(item)">{{item.userName}}</Tag>
                            </div>
